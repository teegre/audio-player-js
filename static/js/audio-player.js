...
function makePlaylist() {
  ...
  for (const track of audio.children) {
    ...
    btn.innerHTML = "<img src='static/img/play.svg'>";
...
function updateTrackInfo() {
  ...
  if (audio.paused) {
    play_btn.innerHTML = "<img src='static/img/play.svg'>";
    btn.innerHTML = "<img src='static/img/play.svg'>";
    document.title = pageTitle;
  } else {
    play_btn.innerHTML = "<img src='static/img/pause.svg'>";
    btn.innerHTML = "<img src='static/img/pause.svg'>";
